...
class LdapOptions
{
    ...
    {
        return $this->GetConfig(LdapConfig::BINDDN);
    }

    public function BindPassword()
    {
        return $this->GetConfig(LdapConfig::BINDPW);
    }
    ...
    {
        return $this->GetConfig(LdapConfig::PORT, new IntConverter());
    }
    ...
    {
        return $this->GetConfig(LdapConfig::VERSION, new IntConverter());
    }
    ...
    {
        return $this->GetConfig(LdapConfig::STARTTLS, new BooleanConverter());
    }
    ...
    {
        return ($this->GetConfig(LdapConfig::USESSL, new BooleanConverter()) || $this->Port() == 636);
    }
}