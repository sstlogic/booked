...
class de_de extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // BEGIN added by SLUB
        $strings['ReservationsNav'] = 'Reservierungen';
        $strings['PrintReservations'] = 'Reservierungen drucken';
        $strings['HideAvailability'] = 'Verfügbarkeit anzeigen';
        $strings['ViewAvailability'] = 'Verfügbarkeit ausblenden';
        $strings['Owner'] = 'Reservierung für';
        $strings['ChangeReservation'] = 'Reservierung ändern';
        $strings['TermsAcceptedOn'] = 'akzeptiert am {{acceptDate}}';
        $strings['DeleteReservationModalTitle'] = 'Reservierung löschen';
        $strings['ReservationDeleted'] = 'Ihre Reservierung wurde gelöscht.';
        $strings['UserConcurrentLimitError'] = 'Es ist nur eine Reservierung zur selben Zeit möglich.';
        $strings['StartTimeIsInPast'] = 'Der Starzeitpunkt darf nicht in der Vergangenheit liegen.';
        $strings['StandardView'] = 'Standardansicht';
        $strings['WideView'] = 'Querformat';
        $strings['TallView'] = 'Hochformat';
        $strings['WeekView'] = 'Wochenansicht';
        $strings['BetweenAnyTimes'] = 'jederzeit';
        $strings['Custom'] = 'benutzerdefiniert';
        $strings['OnlyApplicableAccessories'] = 'Zeige nur Zubehör an, welche mit der gewählten Ressource ausgewählt werden kann.';
        $strings['Utilization'] = 'Auslastung';
        $strings['SlotLabel'] = 'Kennzeichnung Zeitfenster';
        $strings['PublicAccess'] = 'Öffentlicher Zugriff';
        $strings['NoMinimum'] = 'kein Minimum';
        $strings['MinimumParticipants'] = 'Mindestteilnehmerzahl';
        $strings['ResourceMinLength'] = 'Reservierungen müssen mindestens <strong>%s</strong>';
        $strings['hours'] = 'Stunde';
        $strings['ResourceAdvanceNoticeCreate'] = 'Vorlaufzeit für neue Reservierungen';
        $strings['ResourceAdvanceNoticeUpdate'] = 'Vorlaufzeit für Reservierungsänderungen';
        $strings['ResourceAdvanceNoticeDelete'] = 'Vorlaufzeit für gelöschte Reservierung';
        $strings['ResourceMaxNoticeEnd'] = 'maximale Vorlaufzeit für neue Reservierungen';
        $strings['ResourceConcurrentReservationsNone'] = '<strong>Keine</strong> gleichzeitige Reservierungen möglich.';
        $strings['ChangeUserAndGroupPermissions'] = 'Benutzer- und Gruppenberechtigungen ändern';
        $strings['ResourceRelationships'] = 'Verbindungen';
        $strings['MustBeBookedWith'] = 'muss mit reserviert werden';
        $strings['CannotBeBookedWith'] = 'kann nicht mit reserviert werden';
        $strings['CannotBeBookedAtSameTime'] = 'kann nicht zur gleichen Zeit mit reserviert werden';
        $strings['Default'] = 'Standardeinstellung';
        $strings['ResourceNameRequired'] = 'Ressourcenname ist erforderlich.';
        $strings['ResourceAdminRequired'] = 'Ressource Administrator ist erforderlich.';
        $strings['AddMoreResources'] = 'Weitere Ressourcen hinzufügen';
        $strings['QuickSlotCreationTimes'] = 'Erzeuge reservierbare Zeiträume alle %s Minuten zwischen';
        $strings['ScheduleConcurrentMaximumNone'] = 'Die Anzahl der gleichzeitig reservierten Ressourcen ist unbegrenzt.';
        $strings['ScheduleResourcesPerReservationNone'] = 'Die Anzahl der Ressourcen pro Reservierung ist unbegrenzt.';
        $strings['ReservationsMustEndInAvailableSlots'] = 'Reservierungen müssen in verfügbaren Zeitfenstern enden.';
        $strings['Accessories'] = 'Zubehör';
        $strings['ShowSpecificDates'] = 'Ausgewählte Tage anzeigen';
        $strings['MobileView'] = 'Mobile Ansicht';
        $strings['AddFavoriteResource'] = 'Bevorzugte Ressource hinzufügen';
        // END added by SLUB
...
//        $strings['JoinThisReservation'] = 'Dieser Reservierung hinzufügen';
        ...
        $strings['Name'] = 'Name';
        $strings['CaptchaInvalid'] = 'Die Captcha-Sicherheitsprüfung ist fehlgeschlagen.';
        $strings['RepeatEveryPrompt'] = 'Jede';
        $strings['CreateReservationHeading'] = 'Neue Reservierung';
        $strings['ReservationsMustLastAtLeast'] = 'Reservierungen müssen mindestens %s andauern';
        $strings['ReservationsCannotLastMoreThan'] = 'Reservierungen können nicht länger dauern als';
        $strings['BetweenReservationsThereMustBeAtLeast'] = 'Zwischen den Reservierungen muss mindestens ein Zeitraum von %s liegen';
        $strings['QuotaConfigurationInterval'] = 'Am %s für %s sind Benutzer in %s auf %s %s alle %s %s begrenzt';
        $strings['Status'] = 'Status';
        $strings['Position'] = 'Position';
        $strings['YouWillBeEmailedPasswordInstructions'] = 'Sie erhalten per E-Mail Anweisungen zur Aktualisierung Ihres Passworts';
        $strings['OK'] = 'OK';
        $strings['Optional'] = 'optional';
        $strings['Filter'] = 'Filter';
        $strings['Format'] = 'Format';
        $strings['Checkbox'] = 'Ankreuzfeld';
        $strings['ResetPasswordEmailSent'] = 'Wenn diese E-Mail-Adresse existiert, erhalten Sie eine E-Mail mit Anweisungen zum Zurücksetzen Ihres Passworts. Diese Anfrage läuft in 30 Minuten ab.';
        $strings['Maximum'] = 'max';
        $strings['Total'] = 'Gesamt';
        $strings['TotalTime'] = 'Zeit';
        $strings['ReminderMessage'] = 'Nachricht';
        $strings['ReminderSendtimeAMPM'] = 'AM / PM';
        $strings['minute'] = 'Minute';
        $strings['hour'] = 'Stunde';
        $strings['Logo'] = 'Logo';
        $strings['Attribut'] = 'Attribut';
        $strings['OnlyCollectInCertainCases'] = 'Nur in bestimmten Fällen sammeln';
        $strings['AutoReleaseDeleteNotification'] = 'Automatisch gelöscht, wenn nicht innerhalb von <strong>%s</strong> Minuten eingecheckt';
        $strings['AutoReleaseEndNotification'] = 'Automatisch beendet, wenn nicht innerhalb von <strong>%s</strong> Minuten eingecheckt';
        $strings['Export'] = 'Exportieren';
        $strings['Sandbox'] = 'Sandbox';
        $strings['Live'] = 'Live';
        $strings['Gateway'] = 'Gateway';
        $strings['Standard'] = 'Standard';
        $strings['NoReservationsFound'] = 'Keine Reservierungen gefunden';
        $strings['EmailReservation'] = 'E-Mail-Reservierung';
        $strings['AdHocMeeting'] = 'Ad-hoc-Besprechung';
        $strings['NextReservation'] = 'Nächste Reservierung';
        $strings['MissedCheckin'] = 'Verpasstes Einchecken';
        $strings['MissedCheckout'] = 'Verpasster Checkout';
        $strings['SpecificTime'] = 'Bestimmte Zeit';
        $strings['NotAttending'] = 'Nicht teilnehmend';
        ...
        $strings['ScheduleConcurrentMaximum'] = 'Insgesamt können <b>%s</b> Ressourcen gleichzeitig reserviert werden';
        $strings['ScheduleMaximumConcurrent'] = 'Maximale Anzahl der gleichzeitig reservierten Ressourcen';
        $strings['ScheduleMaximumConcurrentNote'] = 'Wenn gesetzt, wird die Gesamtzahl der Ressourcen, die gleichzeitig für diesen Terminplan reserviert werden können, begrenzt.';
        $strings['ScheduleResourcesPerReservationMaximum'] = 'Jede Reservierung ist auf ein Maximum von <b>%s</b> Ressourcen begrenzt';
        $strings['ScheduleResourcesPerReservation'] = 'Maximale Anzahl von Ressourcen pro Reservierung';
        $strings['ResourceConcurrentReservations'] = 'Erlaube %s gleichzeitige Reservierungen';
        $strings['AllowConcurrentReservations'] = 'Erlaube %s gleichzeitige Reservierungen';
        $strings['AllowConcurrentReservationsLabel'] = '<strong>Allow</strong> concurrent reservations';
        $strings['ResourceDisplayInstructions'] = 'Es wurde keine Ressource ausgewählt. Die URL zur Anzeige einer Ressource finden Sie in der Anwendungsverwaltung, Ressourcen. Die Ressource muss öffentlich zugänglich sein.';
        ...
        $strings['AllUsersWhoHaveAReservationInTheNext'] = 'Jeder mit einer Reservierung in der nächsten';
        $strings['ChangeResourceStatus'] = 'Ressourcenstatus ändern';
        $strings['UpdateGroupsOnImport'] = 'Vorhandene Gruppe aktualisieren, wenn Name übereinstimmt';
        $strings['GroupsImportInstructions'] = '<ul><li>Die Datei muss im CSV-Format vorliegen.</li><li>Der Name ist erforderlich.</li><li>Mitgliederlisten sollten kommagetrennte Listen von E-Mails sein.</li><li>Leere Mitgliederlisten beim Aktualisieren von Gruppen lassen die Mitglieder unverändert.</li><li>Berechtigungslisten sollten kommagetrennte Listen von Ressourcennamen sein.</li><li>Leere Berechtigungslisten bei der Aktualisierung von Gruppen lassen die Berechtigungen unverändert.</li><li>Verwenden Sie die mitgelieferte Vorlage als Beispiel.</li></ul>';
        $strings['PhoneRequired'] = 'Telefon ist erforderlich';
        $strings['OrganizationRequired'] = 'Organisation ist erforderlich';
        $strings['PositionRequired'] = 'Position ist erforderlich';
        $strings['GroupMembership'] = 'Gruppenmitgliedschaft';
        ...
        $strings['ApiOnly'] = 'Nur API-Zugriff';
        $strings['ApiOnlyDetails'] = 'Dieser Benutzer kann sich nur über die API anmelden';
        $strings['PerReservation'] = 'pro Reservierung';
        $strings['PerSlot'] = 'pro Slot';
        $strings['CreditsCalculated'] = 'Guthaben berechnet';
        $strings['CreditsApplied'] = 'Guthaben Anwendbarkeit';
        $strings['CreditsChargedBlockedSlots'] = 'Guthaben werden für blockierte Slots berechnet';
        $strings['AllowReservationsToEndInBlockedSlots'] = 'Erlaubt, dass Reservierungen in blockierten Slots enden';
        $strings['Currently'] = 'Derzeit';
        $strings['ResourceDisplay'] = 'Ressourcenanzeige';
        $strings['CopyToClipboard'] = 'In die Zwischenablage kopieren';
        $strings['CopyEmbedCode'] = 'Einbettungscode in die Zwischenablage kopieren';
        $strings['CopyRssLink'] = 'RSS-Link in die Zwischenablage kopieren';
        $strings['CopyICalLink'] = 'iCalendar-Link in die Zwischenablage kopieren';
        $strings['CopyToResourceDisplay'] = 'Link zur Ressourcenanzeige in die Zwischenablage kopieren';
        $strings['CopiedToClipboard'] = 'In die Zwischenablage kopiert';
        $strings['UseDefaultLabel'] = 'Standard-Label verwenden';
        $strings['UpdateAndSend'] = 'Aktualisieren und benachrichtigen';
        $strings['ResourceImageInstructions'] = 'Bis zu 10 Bilder sind erlaubt (je %sMB). nur jpg, gif, png, svg. ziehen, um neu zu ordnen';
        $strings['ViewFullSizeImage'] = 'Bild in voller Größe anzeigen';
        $strings['DisplayInformation'] = 'Informationen anzeigen';
        $strings['ResourceInformation'] = 'Ressourcen - Informationen';
        $strings['CopyId'] = 'ID in die Zwischenablage kopieren';
        $strings['AllowPublicAccess'] = 'Öffentlichen Zugriff zulassen';
        $strings['AddAllUsers'] = 'Alle Benutzer hinzufügen';
        $strings['ChangeAllAccess'] = 'Alle Benutzer ändern';
        $strings['ChangeAllGroupAccess'] = 'Alle Gruppen ändern';
        $strings['View'] = 'Ansicht';
        $strings['NoUsersHavePermission'] = 'Keine Benutzer haben Berechtigung';
        $strings['RemoveAllPermissions'] = 'Alle Berechtigungen entfernen';
        $strings['RemovePermissions'] = 'Berechtigungen entfernen';
        $strings['InheritPermissions'] = 'Berechtigungen entfernen und vererben';
        $strings['DateFilter'] = 'Datumsfilter';
        $strings['Equals'] = 'Gleich';
        $strings['GreaterThan'] = 'Größer als';
        $strings['LessThan'] = 'Kleiner als';
        $strings['HasNoValue'] = 'Hat keinen Wert';
        $strings['NoResourcesInstructions'] = 'Sie haben keine Ressourcen . Klicken Sie oben auf Add Resource, um eine neue Ressource hinzuzufügen.<br /><br />Sie können mehr über Ressourcen in Booked <a href="{{resourceLink}}">hier</a> erfahren.<br /><br />Neu bei Booked? Lesen Sie unseren <a href="{{gettingStartedLink}}">Getting Started Guide</a>';
        $strings['AddMoreResourcesInfo'] = 'Nach dem Hinzufügen einer Ressource auf dieser Seite verbleiben';
        $strings['ResourceSuccessfullyAdded'] = '{{RessourceName}} wurde hinzugefügt.';
        $strings['ViewAsList'] = 'Als Liste anzeigen';
        $strings['ViewDetails'] = 'Details anzeigen';
        $strings['DeleteItemModalTitle'] = '{{itemName}} löschen?';
        $strings['Expand'] = 'Erweitern';
        $strings['Collapse'] = 'Zusammenklappen';
        $strings['DeleteMultiple'] = 'Mehrere löschen';
        $strings['DeleteMultipleModalTitle'] = 'Mehrere löschen ({{count}})?';
        $strings['DeleteMultipleResourcesWarning'] = 'Dadurch werden alle Ressourcen, die mit dem aktuellen Filter übereinstimmen, dauerhaft gelöscht, einschließlich';
        $strings['ExportAllResources'] = 'Alle Ressourcen exportieren';
        $strings['ExportFilteredResources'] = 'Gefilterte Ressourcen exportieren';
        $strings['ExportResourceInstructions'] = 'Eine CSV-Datei mit Ressourceninformationen herunterladen. Die exportierten Daten können für Massenänderungen erneut importiert werden.';
        $strings['ImportResourcesConfirm'] = 'Importiere {{count}} Ressourcen';
        $strings['NoResourceGroups'] = 'Es gibt keine Ressourcengruppen';
        $strings['ShareCalendar'] = 'Terminplan freigeben';
        $strings['DoNotShareCalendar'] = 'Terminplan nicht freigeben';
        $strings['BackToMainCalendar'] = 'Zurück zum Hauptterminplan';
        $strings['ReservationsFound'] = '%s Reservierungen gefunden';
        $strings['DeleteAll'] = 'Alle löschen';
        $strings['CopyResource'] = 'Ressource kopieren';
        $strings['DateOfMonth'] = 'Datum des Monats';
        $strings['WeekOfMonth'] = 'Woche des Monats';
        $strings['Rules'] = 'Regeln';
        $strings['ReservationMustBeBookedTogether'] = 'Diese Ressourcen müssen zusammen gebucht werden';
        $strings['ReservationRequiredResourceNoPermission'] = 'Sie haben keine Berechtigung für einige der benötigten Ressourcen';
        $strings['AddRequiredResources'] = 'Erforderliche Ressourcen hinzufügen';
        $strings['AddNewMonitorView'] = 'Monitoransicht hinzufügen';
        $strings['UpdateMonitorView'] = 'Monitor-Ansicht aktualisieren';
        $strings['DeleteMonitorView'] = 'Monitor-Ansicht löschen';
        $strings['DeleteMonitorViewPrompt'] = 'Sind Sie sicher, dass Sie <strong>{{viewName}}</strong> löschen wollen?';
        $strings['ReservationsToShow'] = 'Zu zeigende Reservierungen';
        $strings['ASetNumberOfUpcomingReservations'] = 'Eine bestimmte Anzahl von bevorstehenden Reservierungen';
        $strings['AllReservationsWithinADateRange'] = 'Alle Reservierungen innerhalb eines Datumsbereichs';
        $strings['ASpecificSetOfReservations'] = 'Eine bestimmte Anzahl von Reservierungen';
        $strings['UpcomingDaysToShow'] = 'Kommende Tage zu zeigen';
        $strings['UpcomingReservationsToShow'] = 'Zukünftig anzuzeigende Reservierungen';
        $strings['DisplayOptions'] = 'Anzeigeoptionen';
        $strings['Style'] = 'Stil';
        $strings['ScrollInterval'] = 'Scroll-Intervall (Sekunden)';
        $strings['ShowReservations'] = 'Reservierungen anzeigen';
        $strings['ShowLogo'] = 'Logo anzeigen';
        $strings['ShowDateAndTime'] = 'Datum und Uhrzeit anzeigen';
        $strings['Invited'] = 'Eingeladen';
        $strings['SelectUserOrAddGuest'] = 'Benutzer auswählen oder Gast per E-Mail hinzufügen';
        $strings['ReservationUploadInstructions'] = 'Hochladen von Dateien des Typs %s bis zu %s';
        $strings['UploadFiles'] = 'Ziehen Sie Dateien hierher oder klicken Sie, um Dateien zum Hochladen auszuwählen';
        $strings['RetryReservationNotice'] = 'Sie können diese Reservierung wiederholen, wobei Termine mit Konflikten übersprungen werden.';
        $strings['JoinWaitlistReservationNotice'] = 'Sie können sich auf eine Warteliste setzen lassen, um benachrichtigt zu werden, wenn dieser Termin frei wird.';
        $strings['NewReservation'] = 'Neue Reservierung';
        $strings['UpdateRecurringTitle'] = 'Reservierung aktualisieren';
        $strings['ParticipantRecurringNotice'] = 'Diese Reservierung ist Teil einer wiederkehrenden Serie';
        $strings['UpdateRecurringNotice'] = 'Diese Reservierung ist Teil einer wiederkehrenden Serie. Welche Instanzen der Serie möchten Sie aktualisieren?';
        $strings['DeleteRecurringNotice'] = 'Diese Reservierung ist Teil einer wiederkehrenden Serie. Welche Instanzen der Serie möchten Sie löschen?';
        $strings['RequiresApprovalNotice'] = 'Diese Reservierung erfordert Ihre Zustimmung.';
        $strings['AcceptInvitation'] = 'Einladung annehmen';
        $strings['DeclineInvitation'] = 'Einladung ablehnen';
        $strings['YouAreAlreadyParticipating'] = 'Sie sind bereits an dieser Reservierung beteiligt';
        $strings['JoinAsGuestNotice'] = 'Um dieser Reservierung als Gast beizutreten, müssen Sie Ihre E-Mail-Adresse angeben';
        $strings['CancelThisInstance'] = 'Diese Instanz stornieren';
        $strings['CancelSeries'] = 'Serie stornieren';
        $strings['DeclineThisInstance'] = 'Diese Instanz ablehnen';
        $strings['DeclineSeries'] = 'Ablehnungsserie';
        $strings['AcceptThisInstance'] = 'Diese Instanz akzeptieren';
        $strings['AcceptSeries'] = 'Accept Series';
        $strings['JoinThisInstance'] = 'An dieser Instanz teilnehmen';
        $strings['JoinSeries'] = 'Serie beitreten';
        $strings['MultipleEmailInstructions'] = 'Sie können mehrere E-Mail-Adressen hinzufügen, getrennt durch ein Leerzeichen oder ein Komma';
        $strings['SendReservationAsEmail'] = 'E-Mail senden ({{count}})';
        $strings['WithSpecificAttributeValues'] = 'Mit spezifischen Attributwerten';
        $strings['ReferenceNumbers'] = 'Referenznummern';
        $strings['Wert'] = 'Wert';
        $strings['Ascending'] = 'Aufsteigend';
        $strings['Descending'] = 'Absteigend';
        $strings['SortDirection'] = 'Richtung';
        $strings['SortBy'] = 'Sortieren nach';
        $strings['LoadingCreditHistory'] = 'Kreditgeschichte laden';
        $strings['HeadingText'] = 'Überschrift Text';
        $strings['GroupCredits'] = 'Guthaben';
        $strings['Replenish'] = 'Wiederauffüllen';
        $strings['AddCredits'] = 'Guthaben hinzufügen';
        $strings['ReplenishCredits'] = 'Guthaben wieder auffüllen';
        $strings['AddCreditsEveryDays'] = '%s Guthaben alle %s Tage hinzufügen';
        $strings['AddCreditsDayOfMonth'] = '%s Guthaben am Tag %s eines jeden Monats hinzufügen';
        $strings['AutomaticallyAddCredits'] = 'Automatisch Guthaben für alle Benutzer in dieser Gruppe hinzufügen';
        $strings['AddCreditsToGroup'] = 'Guthaben für alle Benutzer in dieser Gruppe hinzufügen';
        $strings['AddNumberCreditsToGroup'] = 'Allen Benutzern in dieser Gruppe %s Guthaben hinzufügen';
        $strings['CreditsAddedByAdminNote'] = 'Vom Administrator hinzugefügte Credits';
        $strings['AutoReplenishCreditsNote'] = 'Guthaben werden automatisch wieder aufgefüllt';
        $strings['Never'] = 'Niemals';
        $strings['LastReplenished'] = 'Zuletzt wieder aufgefüllt';
        $strings['ReservationsAutomaticallyExtended'] = 'Reservierungen werden automatisch verlängert, wenn der Besitzer nicht auscheckt';
        $strings['ReservationsNotAutomaticallyExtended'] = 'Reservierungen enden, wenn der Besitzer nicht auscheckt';
        $strings['PasswordResetForced'] = 'Sie müssen Ihr Passwort aktualisieren';
        $strings['ForceChangePassword'] = 'Den Benutzer zwingen, sein Passwort beim nächsten Login zu ändern';
        $strings['NotifyUserPasswordChange'] = 'Sende dem Benutzer eine E-Mail mit dem neuen Passwort';
        $strings['NoScheduleAdminGroupsDefined'] = 'Keine Zeitplan-Administratorgruppen definiert';
        $strings['SecurityCheck'] = 'Sicherheitsüberprüfung';
        $strings['SecurityCheckInstructions'] = 'Zu Ihrer Sicherheit müssen wir Ihr Konto bestätigen. Bitte geben Sie den einmaligen Passcode ein, der an %s gesendet wurde';
        $strings['OneTimePassCode'] = 'Einmaliger Passcode';
        $strings['ConfirmOTP'] = 'Passcode bestätigen';
        $strings['ResendCode'] = 'Neuen Passcode senden';
        $strings['InvalidOtp'] = 'Der Passcode ist falsch oder abgelaufen, bitte versuchen Sie es erneut oder fordern Sie einen neuen Einmal-Passcode an';
        $strings['OtpResendMessage'] = 'Wir haben Ihnen einen neuen einmaligen Passcode geschickt, der in 10 Minuten abläuft.';
        $strings['ResetPasswordInstructions'] = 'Bitte geben Sie ein neues Passwort ein';
        $strings['ResendResetPassword'] = 'Link zum Zurücksetzen erneut senden';
        $strings['ResetPasswordError'] = 'Ungültiger Link zum Zurücksetzen des Passworts. Links zum Zurücksetzen des Passworts sind nur für %s Minuten gültig.';
        $strings['SendResetLink'] = 'Link zum Zurücksetzen senden';
        $strings['ConfirmResetPassword'] = 'Ihr Passwort wurde aktualisiert, bitte melden Sie sich mit Ihrem neuen Passwort an.';
        $strings['TransferReservationOwnership'] = 'Eigentümerschaft übertragen';
        $strings['TransferTo'] = 'Übertragen an';
        $strings['FutureReservations'] = 'Zukünftige Reservierungen';
        $strings['TransferOwnershipDeleteWarning'] = 'Sie können das Eigentum an Reservierungen übertragen, um diese Reservierungen zu behalten';
        $strings['TransferReservationOwnershipNote'] = 'Reservierungseigentum auf eine andere Person übertragen.';
        $strings['RemoveFavoriteResource'] = 'Bevorzugte Ressource entfernen';
        $strings['ReservationsCheckinLimitedToAdmin'] = 'Nur Administratoren können ein-/auschecken';
        $strings['PermissionLevel'] = 'Stufe';
        $strings['Inherit'] = 'Vererben';
        $strings['NoGroupsHavePermission'] = 'Keine Gruppen haben die Berechtigung';
        $strings['AddAllGroups'] = 'Alle Gruppen hinzufügen';
        $strings['NoColor'] = 'Keine Farbe';
        $strings['UseDefault'] = 'Standard verwenden';
        $strings['DeletingReservation'] = 'Löschung der Reservierung';
        $strings['ResourceTypes'] = 'Ressourcentypen';
        $strings['Enabled'] = 'Aktiviert';
        $strings['CheckAvailability'] = 'Verfügbarkeit prüfen';
        $strings['ManageAvailableAppointments'] = 'Verfügbare Termine verwalten';
        $strings['AddAvailableAppointmentTime'] = 'Verfügbare Terminzeit hinzufügen';
        $strings['SelectThisAppointment'] = 'Diesen Termin auswählen';
        $strings['AppointmentTime'] = 'Uhrzeit des Termins';
        $strings['NoAvailableAppointments'] = 'Für Ihr ausgewähltes Datum sind keine Termine verfügbar, bitte wählen Sie ein anderes Datum';
        $strings['NoAppointmentsOnDay'] = 'Keine Termine';
        $strings['BackDays'] = 'Letzte %s Tage';
        $strings['ForwardDays'] = 'Nächste %s Tage';
        $strings['LastWeek'] = 'Letzte Woche';
        $strings['ShowMultiResourceGrouped'] = 'Multi-Ressourcen-Reservierungen als einzelnes Ereignis anzeigen';
        $strings['Zeit'] = 'Zeit';
        $strings['YourAccountWasCreatedOn'] = 'Ihr Konto wurde erstellt am %s';
        $strings['MissedCheckinTimeWarning'] = 'Diese Reservierung hat die Checkin-Zeit verpasst';
        $strings['MissedCheckoutTimeWarning'] = 'Bei dieser Reservierung wurde die Checkout-Zeit verpasst';
        $strings['CheckedIn'] = 'Eingecheckt';
        $strings['CheckedOut'] = 'Ausgecheckt';
        $strings['SelectUserOrGroup'] = 'Benutzer oder Gruppe auswählen';
        $strings['NoGroupsAssigned'] = '- Keine Gruppen zugewiesen -';
        $strings['CurrentlyFilteredResources'] = 'Derzeit gefilterte Ressourcen (%s)';
        $strings['AllResourcesWithCount'] = 'Alle Ressourcen (%s)';
        $strings['Section'] = 'Abschnitt';
        $strings['BulkUpdateWarning'] = 'Es wird empfohlen, eine Sicherungskopie Ihrer Ressourcen zu exportieren, bevor Sie eine Massenaktualisierung durchführen';
        $strings['DuplicateResourceImportWarning'] = 'Wir haben doppelte Ressourcennamen gefunden . Wenn Sie die vorhandenen Ressourcen aktualisieren möchten, aktivieren Sie bitte das Aktualisierungskästchen unten';
        $strings['EventsPerPage'] = 'Ereignisse pro Seite';
        $strings['ScheduleReport'] = 'Bericht Terminplan';
        $strings['ChangeSchedule'] = 'Terminplan ändern';
        $strings['Frequency'] = 'Häufigkeit';
        $strings['SendTo'] = 'Senden an';
        $strings['ScheduleReportOnThe'] = 'Am';
        $strings['ScheduleReportDayOfTheMonth'] = 'Tag des Monats';
        $strings['AtLeastOneDayMustBeSelected'] = 'Es muss mindestens ein Tag ausgewählt werden';
        $strings['AtLeastOneEmailMustBeAdded'] = 'Mindestens eine E-Mail muss hinzugefügt werden';
        $strings['LastSent'] = 'Zuletzt gesendet';
        $strings['ReservationColor'] = 'Farbe der Reservierung';
        $strings['PhoneCountry'] = 'Telefonland';
        $strings['SmsDisabled'] = 'SMS-Benachrichtigungen sind nicht aktiviert.';
        $strings['PreferenceReservationReminders'] = 'Reservierungserinnerungen';
        $strings['PreferenceReservationCreated'] = 'Reservierung erstellt';
        $strings['PreferenceReservationUpdated'] = 'Reservierung aktualisiert';
        $strings['PräferenzReservierungGelöscht'] = 'Reservierung gelöscht';
        $strings['PreferenceReservationApproved'] = 'Reservierung genehmigt';
        $strings['PreferenceReservationParticipants'] = 'Reservierungs-Teilnehmer';
        $strings['PreferenceReservationSeriesEnding'] = 'Ende der Reservierungs-Serie';
        $strings['PreferenceReservationMissedCheckin'] = 'Verpasster Reservierungs-Check-In';
        $strings['PreferenceReservationMissedCheckout'] = 'Verpasste Reservierung Check Out';
        $strings['ReservationRemindersPreferenceDescription'] = 'Erinnerungen an den Beginn und das Ende einer Reservierung; wenn aktiviert, werden die Erinnerungen immer per E-Mail versendet';
        $strings['ReservationCreatedPreferenceDescription'] = 'Wenn Sie eine Reservierung erstellen oder jemand eine Reservierung in Ihrem Namen erstellt.';
        $strings['ReservationUpdatedPreferenceDescription'] = 'Wenn Sie eine Reservierung aktualisieren oder jemand eine Reservierung in Ihrem Namen aktualisiert.';
        $strings['ReservationDeletedPreferenceDescription'] = 'Wenn Sie eine Reservierung löschen oder jemand eine Reservierung in Ihrem Namen löscht.';
        $strings['ReservationApprovedPreferenceDescription'] = 'Wenn Ihre ausstehende Reservierungsanfrage genehmigt wurde.';
        $strings['ReservationParticipantsPreferenceDescription'] = 'Wenn jemand eine Einladung annimmt oder seine Teilnahme an Ihrer Reservierung storniert.';
        $strings['ReservationSeriesEndingPreferenceDescription'] = 'Wenn das letzte Ereignis einer wiederkehrenden Reservierung bevorsteht.';
        $strings['ReservationMissedCheckinPreferenceDescription'] = 'Wenn Sie für eine begonnene Reservierung nicht eingecheckt haben.';
        $strings['ReservationMissedCheckoutPreferenceDescription'] = 'Wenn Sie für eine Reservierung, die beendet wurde, nicht ausgecheckt haben.';
        $strings['NotificationPreferenceOnlyEmail'] = 'Diese Benachrichtigung ist nur per E-Mail verfügbar.';
        $strings['SMSNotifications'] = 'SMS-Benachrichtigungen';
        $strings['SMSPhoneMissing'] = 'Um SMS-Nachrichten zu erhalten, geben Sie bitte Ihre Telefonnummer an.';
        $strings['UpdateYourProfile'] = 'Aktualisieren Sie Ihr Profil';
        $strings['SMSConfirmCode'] = 'Bitte geben Sie den Passcode ein, den wir an Ihre Telefonnummer gesendet haben (%s)';
        $strings['SMSUpdateYourPhone'] = 'Aktualisieren Sie Ihre Telefonnummer';
        $strings['SMSNeedToConfirm'] = 'Wir müssen Ihre Telefonnummer bestätigen, bevor wir Ihnen SMS-Nachrichten senden können.';
        $strings['SendConfirmationCode'] = 'Senden Sie mir einen Passcode';
        $strings['SMSUnavailableCountry'] = 'Wir sind nicht in der Lage, SMS-Nachrichten in Ihr Land zu senden.';
        $strings['SMSOptInConfirmation'] = 'Sie haben sich für SMS-Benachrichtigungen entschieden. Alle aktivierten Benachrichtigungen werden an folgende Adresse gesendet';
        $strings['SmsMoreInfo'] = 'Erfahren Sie mehr über die Einrichtung von SMS für Booked.';
        $strings['SMSAllowedMessagesPerMonth'] = 'Erlaubte Nachrichten pro Monat';
        $strings['SMSSentThisMonth'] = 'Diesen Monat gesendet';
        $strings['SMSRemainingThisMonth'] = 'Verbleibend diesen Monat';
        $strings['SMSAdjustSettingContact'] = 'Um Ihre SMS-Einstellungen anzupassen, wenden Sie sich an';
        $strings['Optionen'] = 'Optionen';
        $strings['Calendar'] = 'Terminplan';
        $strings['PartialMatch'] = 'Teilweise Übereinstimmung';
        $strings['UpdateThisReport'] = 'Diesen Bericht aktualisieren';
        $strings['CancelNotification'] = 'Benachrichtigung abbrechen';
        $strings['WaitlistSingle'] = 'Auf dieses Zeitfenster wartet jemand';
        $strings['WaitlistPlural'] = 'Es warten %s andere auf diesen Termin';
        $strings['Waitlist'] = 'Warteliste';
        $strings['WaitlistRequests'] = 'Wartelistenanfragen';
        $strings['AddMeetingLink'] = 'Meeting-Link hinzufügen';
        $strings['RemoveMeetingLink'] = 'Besprechungs-Link entfernen';
        $strings['OpenLink'] = 'Link öffnen';
        $strings['MeetingLink'] = 'Meeting-Link';
        $strings['ZoomMeetingsOwnerOnly'] = 'Zoom-Meetings können nur vom Besitzer der Reservierung erstellt werden.';
        $strings['ZoomMeetingsOwnerOnlyUpdate'] = 'Aktualisierungen von Zoom-Meetings können nur vom Reservierungseigentümer vorgenommen werden.';
        $strings['ZoomMeetingWillBeCreated'] = 'Es wird ein Zoom-Meeting erstellt';
        $strings['MustLinkZoomAccount'] = 'Sie müssen Ihr Zoom-Konto verknüpfen';
        $strings['ZoomDoesNotSupportCustomRecurrence'] = 'Zoom unterstützt keine benutzerdefinierte Wiederholung. Ein Meeting wird nur für das erste Reservierungsdatum erstellt.';
        $strings['TeamsMeetingsOwnerOnly'] = 'Teams-Meetings können nur vom Eigentümer der Reservierung erstellt werden.';
        $strings['TeamsMeetingsOwnerOnlyUpdate'] = 'Aktualisierungen von Teams-Meetings können nur vom Eigentümer der Reservierung durchgeführt werden.';
        $strings['TeamsMeetingWillBeCreated'] = 'Es wird ein Teams-Meeting erstellt';
        $strings['MustLinkTeamsAccount'] = 'Sie müssen Ihr Microsoft-Konto verknüpfen.';
        $strings['TeamsDoesNotSupportCustomRecurrence'] = 'Teams unterstützt keine benutzerdefinierte Wiederholung. Ein Meeting wird nur für das erste Reservierungsdatum erstellt.';
        $strings['LinkedAccounts'] = 'Verknüpfte Konten';
        $strings['Linked'] = 'Verknüpft';
        $strings['Unlinked'] = 'Unlinked';
        $strings['LinkAccount'] = 'Verknüpftes Konto';
        $strings['UnlinkAccount'] = 'Unlink-Konto';
        $strings['DateFormat'] = 'Datumsformat';
        $strings['TimeFormat'] = 'Zeitformat';
        $strings['ChangeOwner'] = 'Eigentümer ändern';
        $strings['CoOwners'] = 'Mitbesitzer';
        $strings['AddCoOwners'] = 'Miteigentümer hinzufügen';
        $strings['ChangeCoOwners'] = 'Miteigentümer ändern';
        $strings['RemoveCoOwner'] = 'Miteigentümer entfernen';
        $strings['CoOwner'] = 'Miteigentümer';
        $strings['MeineReservierungen'] = 'Meine Reservierungen';
        $strings['ShowLegend'] = 'Legende anzeigen';
        $strings['HideLegend'] = 'Legende ausblenden';
        $strings['AttributeCategory'] = 'Attribut-Kategorie';
        $strings['MultipleSelect'] = 'Mehrfachauswahl';
        $strings['MustBeBookedWithOneWay'] = 'Muss mit (One Way) gebucht werden';
        $strings['QuotaOn'] = 'Ein';
        $strings['QuotaEachPersonIn'] = 'Jede Person in';
        $strings['QuotaIsLimitedTo'] = 'Ist begrenzt auf';
        $strings['QuotaStopEnforcement'] = 'Erzwingung stoppen';
        $strings['QuotaAheadOfCurrentTime'] = 'ab dem aktuellen Zeitpunkt';
        $strings['Every'] = 'Jeder';
        $strings['Enforced'] = 'Erzwungen';
        $strings['Quotas'] = 'Kontingente';
        $strings['UpdateQuota'] = 'Kontingent aktualisieren';
        $strings['UpTo'] = 'Bis zu';
        $strings['AddResourceMap'] = 'Ressourcenkarte hinzufügen';
        $strings['Map'] = 'Karte';
        $strings['Published'] = 'Veröffentlicht';
        $strings['Draft'] = 'Entwurf';
        $strings['MapName'] = 'Kartenname';
        $strings['MapImageInstructions'] = 'Wählen Sie eine Kartenbilddatei, nur Bilder, Mindestbreite %s, maximale Breite %s';
        $strings['AdvancedSearchOptions'] = 'Erweiterte Suchoptionen';
        $strings['CreditsAreNotEnabled'] = 'Die Verwendung von Guthaben ist nicht aktiviert';
        $strings['JoinReservation'] = 'Reservierung beitreten';
        $strings['DeleteReason'] = 'Löschgrund';
        $strings['AddOAuthProvider'] = 'OAuth-Anbieter hinzufügen';
        ...
        $strings['OAuthAuthorizationUrl'] = 'Autorisierungs-URL';
        $strings['OAuthAccessTokenUrl'] = 'Zugriffstoken-URL';
        $strings['OAuthUserDetailsTokenUrl'] = 'Benutzerdetails (Ressourcenbesitzer) URL';
        $strings['FieldMappings'] = 'Feld-Zuordnungen';
        $strings['UpdateOAuthProvider'] = 'OAuth-Provider aktualisieren';
        $strings['LoginWith'] = 'Anmelden mit';
        $strings['OAuthRedirectInstructions'] = 'OAuth-Provider können diese Redirect-URL verlangen, wenn sie einen neuen Client konfigurieren';
        $strings['TheValueForReservationAttribute'] = 'Der Wert für das Reservierungsattribut';
        $strings['UpdateRule'] = 'Aktualisierungsregel';
        $strings['OAuthProvider'] = 'OAuth-Anbieter';
        $strings['ReservationColorRule'] = 'Regel für die Farbe der Reservierung';
        $strings['ReservationAttribute'] = 'Reservierungsattribut';
        $strings['SelectAnAttribute'] = 'Wählen Sie ein Attribut';
        $strings['Criteria'] = 'Kriterien';
        $strings['FreigegebeneReservierungen'] = 'Freigegebene Reservierungen';
        $strings['LoginActivationReminder'] = 'Wenn Sie kürzlich ein Konto registriert haben, müssen Sie es aktivieren. Bitte prüfen Sie Ihre E-Mail auf einen Aktivierungslink';
        $strings['ApprovedBy'] = 'Genehmigt von';
        $strings['ApprovalDate'] = 'Genehmigungsdatum';
        $strings['AddAllUsersConfirmation'] = 'Alle aktiven Benutzer zu dieser Gruppe hinzufügen?';
        $strings['SupportsMarkdownNote'] = '(unterstützt Markdown)';
        $strings['SQLStatement'] = 'SQL - Anweisung:';
        $strings['InstancesOverlapRule'] = 'Einige Instanzen der Buchungsreihe überschneiden sich:';
        $strings['MinParticipantsError'] = '%s erfordert mindestens %s Teilnehmer.';
        $strings['MultiDayRuleAll'] = 'Tagesübergreifende Reservierungen sind nicht erlaubt.';
        $strings['WhatCanThisGroupManage'] = 'Was kann diese Gruppe verwalten?';
        $strings['RegisteredAccountRequired'] = 'Nur registrierte Benutzer können Reservierungen buchen';
        $strings['InvalidNumberOfResourcesError'] = 'die maximale Anzahl der Ressourcen, die in einer einzelnen Reservierung reserviert werden können, beträgt %s';
        $strings['ScheduleTotalReservationsError'] = 'Dieser Terminplan erlaubt nur %s Ressourcen, die gleichzeitig reserviert werden können . Diese Reservierung würde dieses Limit an den folgenden Daten verletzen:';
        $strings['ResourceMustBeBookedWith'] = ' %s muss mit %s gebucht werden';
        $strings['ResourceCannotBeBookedWith'] = ' %s kann nicht mit %s gebucht werden';
        $strings['ResourceCannotBeBookedAtSameTimeAs'] = ' %s kann nicht zur gleichen Zeit wie %s gebucht werden';
        $strings['ReservationCannotBeBookedTogether '] = 'die folgenden Ressourcen können nicht zusammen gebucht werden';
        $strings['CorrectErrorsBelow'] = 'Bitte korrigieren Sie die folgenden Fehler';
        $strings['ResourceImageUploadError'] = 'Das Bild konnte nicht hochgeladen werden, überprüfen Sie den Typ und die Größe';
        $strings['ReservationUploadError'] = 'Datei konnte nicht hochgeladen werden . Überprüfen Sie den Typ und die Größe';
        $strings['PastAutoreleaseError'] = 'Diese Reservierung hat den Check - in - Zeitpunkt überschritten und kann nicht geändert werden . ';
        $strings['CannotJoinReservation'] = 'Sie können dieser Reservierung nicht beitreten . ';
        $strings['CannotDeclineReservation'] = 'Sie können diese Reservierung nicht ablehnen . ';
        $strings['WeHadTroubleProcessingYourRequest'] = 'Wir hatten Probleme bei der Bearbeitung Ihrer Anfrage . ';
        $strings['NewPasswordCannotBeTheSameAsOld'] = 'Das neue Passwort kann nicht mit dem alten Passwort übereinstimmen';
        $strings['ResourceQRScanFailed'] = 'die Ressource konnte nicht hinzugefügt werden . Entweder ist der QR - Code nicht für eine gültige Ressource oder Sie haben keine Berechtigung, diese Ressource zu reservieren.';
        $strings['AccessoryQRScanFailed'] = 'Zubehör konnte nicht hinzugefügt werden . Entweder ist der QR - Code nicht für ein gültiges Zubehör oder das Zubehör kann nicht reserviert werden.';
        $strings['TimezoneMismatchError'] = 'Ihr Browser ist auf eine andere Zeitzone eingestellt als Ihr Profil . Dies kann zu Problemen mit den Reservierungszeiten führen.';
        $strings['AddResourceError'] = 'Der Ressource fehlen erforderliche Felder';
        $strings['InvalidMeetingUrlError'] = 'die Besprechungslink - Url ist ungültig';
        $strings['ErrorConnectingToExternalMeeting'] = 'Wir konnten Ihr Konto nicht mit %s verbinden . Bitte aktualisieren Sie diese Seite und verbinden Sie Ihr Konto erneut.';
        $strings['MapImageError'] = 'Nur Bilder . Mindestbreite %s . Maximale Breite %s.';
        $strings['OAuthLoginError'] = 'Ihre Login - Anfrage konnte nicht verarbeitet werden, bitte versuchen Sie es erneut.';
        $strings['CreateReservation'] = 'Neue Reservierung';
        $strings['EditReservation'] = 'Reservierung aktualisieren';
        $strings['ManageReservationSettings'] = 'Reservierungseinstellungen';
        $strings['ManageQuotas'] = 'Kontingente';
        $strings['Verwaltung'] = 'Verwaltung';
        $strings['Reservierung'] = 'Neue Reservierung';
        $strings['Install'] = 'Installation';
        $strings['ManageResourceTypes'] = 'Ressourcentypen';
        $strings['ManageMonitorViews'] = 'Überwachungsansichten';
        $strings['ConfirmAccount'] = 'Sicherheitsüberprüfung';
        $strings['FirstLogin'] = 'Willkommen bei Booked!';
        $strings['ManageMaps'] = 'Ressourcenkarten';
        $strings['ResourceMaps'] = 'Ressourcenkarten';
        $strings['ManageOAuth'] = 'OAuth - Anbieter';
        $strings['DaySundaySingle'] = 'S';
        $strings['DayMondaySingle'] = 'M';
        $strings['DayFridaySingle'] = 'F';
        $strings['TagSamstagEinzel'] = 'S';
        $strings['ParticipantUpdatedSubjectWithResource'] = ' %s aktualisierte eine Reservierung für %s';
        $strings['MissedCheckoutEmailSubject'] = 'Missed checkout for %s';
        $strings['ReservationExtendedEmailSubject'] = 'Reservierung für %s wurde automatisch verlängert';
        $strings['ReservationShareSubject'] = ' %s teilte eine Reservierung für %s';
        $strings['ReservationSeriesEndingSubject'] = 'Reservation series for %s is ending on %s';
        $strings['ReservationParticipantAccept'] = ' %s hat Ihre Reservierungseinladung für %s am %s angenommen';
        $strings['ReservationParticipantDecline'] = ' %s hat Ihre Reservierungseinladung für %s am %s abgelehnt';
        $strings['ReservationParticipantJoin'] = ' %s ist Ihrer Reservierung für %s am %s beigetreten';
        $strings['ReservationAvailableSubject'] = ' %s ist verfügbar für %s';
        $strings['ResourceStatusChangedSubject'] = 'die Verfügbarkeit von %s hat sich geändert';
        $strings['PasswordUpdatedByAdminSubject'] = 'Ihr %s - Passwort wurde geändert';
        $strings['OneTimePasscodeSubject'] = 'Ihr %s Einmal - Passcode';
        $strings['ReservationOwnershipChangedSubject'] = 'die Reservierungen wurden auf Sie übertragen';
        $strings['CoOwnerAddedSubjectWithResource'] = ' %s hat Sie als Miteigentümer zu einer Reservierung für %s hinzugefügt';
        $strings['CoOwnerUpdatedSubjectWithResource'] = ' %s hat eine Reservierung aktualisiert, deren Miteigentümer Sie sind für %s';
        $strings['CoOwnerDeletedSubjectWithResource'] = ' %s löschte eine Reservierung, deren Miteigentümer Sie sind, für %s';
        $strings['PasswordUpdatedByUserSubject'] = 'Ihr gebuchtes Passwort wurde aktualisiert';
        $strings['SMSMessageReservationCreated'] = 'Reservierung für %s bei %s wurde erstellt . %s';
        $strings['SMSMessageReservationApproved'] = 'die Reservierung für %s bei %s wurde genehmigt . %s';
        $strings['SMSMessageReservationDeleted'] = 'Reservierung für %s bei %s wurde gelöscht . %s';
        $strings['SMSMessageReservationUpdated'] = 'Reservierung für %s bei %s wurde aktualisiert . %s';
        $strings['SMSMessageReservationStartReminder'] = 'die Reservierung für %s beginnt um %s . %s';
        $strings['SMSMessageReservationEndReminder'] = 'die Reservierung für %s endet um %s . %s';
        $strings['SMSMessageReservationSeriesEndingReminder'] = 'die letzte Reservierung in der Serie für %s ist am %s. %s';
        $strings['SMSMessageOTP'] = 'Ihr gebuchter einmaliger Passcode ist %s';
        $strings['SMSMessageOTPConfirm'] = 'Vielen Dank, dass Sie Ihre Telefonnummer bestätigt haben . Sie können Ihre gebuchten SMS - Einstellungen in Ihren Benachrichtigungseinstellungen verwalten.';
        $strings['SMSMessageReservationMissedCheckin'] = 'Sie haben die Reservierungs - Check - in - Zeit für %s bei %s verpasst . %s';
        $strings['SMSMessageReservationMissedCheckout'] = 'Sie haben die Check - out - Zeit der Reservierung für %s um %s verpasst . %s';
