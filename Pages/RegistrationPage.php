...
interface IRegistrationPage extends IPage, IActionPage
{
     ...
     * @param CountryCodes $selectedCode
     */
...
class RegistrationPage extends ActionPage implements IRegistrationPage
{
	...
	public function ProcessPageLoad()
	{
        ...
        $this->Set('LockTimezone', Configuration::Instance()->GetSectionKey(ConfigSection::REGISTRATION, ConfigKeys::REGISTRATION_LOCK_TIMEZONE, new BooleanConverter()));
