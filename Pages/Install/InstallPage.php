...
class InstallPage extends Page implements IInstallPage
{
	...
	public function PageLoad()
	{
		...
		$this->Set('ShowUpToDateMessage', false);
		$this->Set('InstallCompletedSuccessfully', false);
		$this->Set('UpgradeCompletedSuccessfully', false);
		$this->Set('InstallFailed', false);
		$this->Set('ShowInstallOptions', false);
		$this->Set('ShowPasswordPrompt', false);
		$this->Set('InstallPasswordMissing', false);
		$this->Set('ShowDatabasePrompt', false);
		$this->Set('installresults', []);
