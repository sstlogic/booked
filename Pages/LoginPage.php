...
interface ILoginPage extends IPage, ILoginBasePage
{
     ...
     * @param boolean $allow
     */
    public function SetPromptedSSO($allow);

    public function BindOAuthClients(array $options);
}
...
class LoginPage extends Page implements ILoginPage
{
    ...
    public function __construct()
    {
        ...
        $this->Set('ShowActivationReminder', false);
    ...
    public function SetShowLoginError()
    {
        ...
        $this->Set('ShowActivationReminder', Configuration::Instance()->GetKey(ConfigKeys::REGISTRATION_REQUIRE_ACTIVATION, new BooleanConverter()));
    }
    ...
    public function SetPromptedSSO($allow)
    {
        $this->Set('PromptedSSO', $allow);
    }

    public function BindOAuthClients(array $options)
    {
        $this->Set("OAuthClients", $options);
    }
}
