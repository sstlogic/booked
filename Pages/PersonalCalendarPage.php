...
class PersonalCalendarPage extends CommonCalendarPage implements ICommonCalendarPage
{
	...
	public function ProcessPageLoad()
	{
		...
		$this->Set('TimeFormat', Resources::GetInstance()->GetDateFormat('calendar_time', $user->DateFormat, $user->TimeFormat));
		$this->Set('DateFormat', Resources::GetInstance()->GetDateFormat('calendar_dates', $user->DateFormat, $user->TimeFormat));
        $this->Set('CreateReservationPage', UrlPaths::RESERVATION);
        $this->Set('GroupName', '');
        $this->Set('GroupId', '');
        $this->Set('pageUrl', Pages::MY_CALENDAR);
        $this->Set('HideCreate', false);
