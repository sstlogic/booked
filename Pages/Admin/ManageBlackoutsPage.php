...
interface IManageBlackoutsPage extends IPageable, IActionPage, IRepeatOptionsComposite, IPageWithId
{
    /**
...
{
    private ManageBlackoutsPresenter $presenter;
    private PageablePage $pageablePage;
    ...
    public function ProcessPageLoad()
    {
        ...
        $addStart = Date::Now()->ToTimezone($userTimezone);
        $addStart = $addStart->SetTime(new Time($addStart->Hour(), 0));
        $this->Set('AddStartDate', $addStart);
        $this->Set('AddEndDate', $addStart->AddHours(1));
