...
class ManageReservationsPage extends ActionPage implements IManageReservationsPage, IPageWithId
{
    protected ManageReservationsPresenter $presenter;

    protected PageablePage $pageablePage;
    ...
    public function __construct()
    {
        ...
        $this->Set('SortField', $this->GetQuerystring(QueryStringKeys::SORT_FIELD));
        $this->Set('SortDirection', $this->GetQuerystring(QueryStringKeys::SORT_DIRECTION));
    ...
    public function GetUserType()
    {
        return $this->GetQuerystring(QueryStringKeys::USER_TYPE);
    }
    ...
    public function SetIsFiltered($isFiltered)
    {
        $this->Set('IsFiltered', $isFiltered);
    }

    public function GetPageId(): int
    {
        return AdminPageIds::Reservations;
    }
}