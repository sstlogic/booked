...
require_once(ROOT_DIR . 'lib/external/FeedWriter/Item.php');
require_once(ROOT_DIR . 'lib/external/FeedWriter/Feed.php');
require_once(ROOT_DIR . 'lib/external/FeedWriter/ATOM.php');
require_once(ROOT_DIR . 'lib/external/FeedWriter/InvalidOperationException.php');
