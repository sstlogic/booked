...
class SqlFilterInSet extends BaseSqlFilter
{
    /**
     * @param string|ISqlFilterColumn $columnName
     * @param string $columnValue
    ...
    protected function GetSql()
    {
        return "FIND_IN_SET({$this->criteria->Variable}, {$this->criteria->Name})";
    }
}
...
class SqlFilterFreeForm extends BaseSqlFilter
{
    ...
    public function AddCriteria($paramName, $paramValue) {
        $this->_criteria[] = new Criteria('', $paramValue, $paramName);
    }
...
class SqlFilterNotNull extends BaseSqlFilter
{
    /**
     * @param string|SqlFilterColumn $columnName
     * @param string $columnValue
    ...
    protected function GetSql()
    {
        return "{$this->criteria->Name} IS NOT NULL";
    }
}