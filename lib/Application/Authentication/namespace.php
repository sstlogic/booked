...
require_once(ROOT_DIR . 'lib/Application/Authentication/IMultiFactorAuthentication.php');
require_once(ROOT_DIR . 'lib/Application/Authentication/MultiFactorAuthentication.php');
require_once(ROOT_DIR . 'lib/Application/Authentication/IOtpGenerator.php');
require_once(ROOT_DIR . 'lib/Application/Authentication/OtpGenerator.php');
require_once(ROOT_DIR . 'lib/Application/Authentication/MaskedEmail.php');