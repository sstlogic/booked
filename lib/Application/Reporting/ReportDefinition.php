...
class ReportDefinition implements IReportDefinition
{
    ...
    public function __construct(IReport $report, $timezone)
    {
        ...
        $orderedColumns = [
            ...
            ColumnNames::OWNER_FULL_NAME_ALIAS => new ReportStringColumn('Owner', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ...
            ColumnNames::COOWNER_LIST => new ReportStringColumn('CoOwners', ChartColumnDefinition::Null()),
            ...
            ColumnNames::RESERVATION_DELETE_REASON => new ReportStringColumn('DeleteReason', ChartColumnDefinition::Null()),
    ...
    public function GetRow($row)
    {
        ...
        if (array_key_exists(ColumnNames::COOWNER_LIST, $row)) {
            $row[ColumnNames::COOWNER_LIST] = str_replace('!sep!', ', ', $row[ColumnNames::COOWNER_LIST] . '');
        }
