...
class ManageEmailTemplatesPresenter extends ActionPresenter
{
    ...
    public function UpdateEmailTemplate()
    {
        ...
        try {
            Log::Debug('Updating email template', ['template' => $templateName]);
            ...
            Log::Debug('Update email template results.', ['template' => $templateName, 'result' => $saveResult]);
            $this->page->SetSaveResult($saveResult);
        }
        catch(Exception $exception)
        {
            Log::Error('Error updating email template.', ['template' => $templateName, 'exception' => $exception]);
