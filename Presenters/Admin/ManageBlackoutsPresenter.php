...
class ManageBlackoutsPresenter extends ActionPresenter
{
    ...
    public function AddBlackout()
    {
        ...
        $blackoutDate = DateRange::Create($startDate, $endDate, $session->Timezone);
    ...
    public function DeleteBlackout()
    {
        ...
        Log::Debug('Deleting blackout.', ['id' => $id, 'scope' => $scope]);
    ...
    public function LoadBlackout()
    {
        ...
        Log::Debug('Loading blackout for editing.', ['id' => $id]);
    ...
    public function UpdateBlackout()
    {
        ...
        Log::Debug('Updating blackout.', ['id' => $id, 'scope' => $scope]);
    ...
    public function DeleteMultiple()
    {
        ...
        Log::Debug('Blackout multiple delete.', ['ids', $ids]);
        foreach ($ids as $id) {
