...
class ManageSchedules
{
    ...
    const ActionChangeBlockedSlotEnding = 'changeBlockedSlotEnding';
}
...
class ManageScheduleService
{
    ...
    {
        Log::Debug('Changing schedule', ['scheduleId' => $scheduleId, 'startDay' => $startDay, 'daysVisible' => $daysVisible]);
        $schedule = $this->scheduleRepository->LoadById($scheduleId);
        if (!is_null($startDay)) {
...
//	}
    ...
    {
        Log::Debug('Updating schedule availability.', ['scheduleId' => $scheduleId, 'start' => $start, 'end' => $end]);
        $schedule = $this->scheduleRepository->LoadById($scheduleId);
    ...
    {
        Log::Debug("Switching layout type.", ['scheduleId' => $scheduleId]);
    ...
    public function AddCustomLayoutPeriod($scheduleId, $start, $end)
    {
        ...
        Log::Debug("Adding custom layout period.", ['scheduleId' => $scheduleId]);
    ...
    public function UpdateCustomLayoutPeriod($scheduleId, $start, $end, $originalStart)
    {
        ...
        Log::Debug("Updating custom layout period.", ['scheduleId' => $scheduleId]);
//        $overlappingPeriod = $this->CustomLayoutPeriodOverlaps($scheduleId, $start, $end);
//        if ($overlappingPeriod != null) {
//
...
//        }
    ...
    public function ChangeReservationsCanEndInBlockedSlots($scheduleId, $allowedEndingInBlockedSlots)
    {
        $schedule = $this->scheduleRepository->LoadById($scheduleId);
        $schedule->SetAllowBlockedEndSlot($allowedEndingInBlockedSlots);
        $this->scheduleRepository->Update($schedule);
    }
}
...
class ManageSchedulesPresenter extends ActionPresenter
{
                                ...
                                IGroupViewRepository  $groupViewRepository)
    {
        ...
        $this->AddAction(ManageSchedules::ActionChangeBlockedSlotEnding, 'ChangeBlockedSlotEnding');
    }
    ...
    public function Add()
    {
        ...
        Log::Debug('Adding schedule', ['name' => $name]);
    ...
    public function ChangeLayout()
    {
        ...
        Log::Debug('Changing layout', ['scheduleId' => $scheduleId, 'timezone' =>  $timezone, 'usingSingleLayout' => $usingSingleLayout]);
    ...
    public function AddLayoutSlot()
    {
        ...
        Log::Debug('Adding custom layout slot.', ['start' => $start, 'end' => $end, 'scheduleId' => $scheduleId]);
    ...
    public function UpdateLayoutSlot()
    {
        ...
        Log::Debug('Updating custom layout slot.', ['start' => $start, 'end' => $end, 'scheduleId' => $scheduleId]);
    ...
    public function DeleteLayoutSlot()
    {
        ...
        Log::Debug('Deleting custom layout slot.', ['start' => $start, 'end' => $end, 'scheduleId' => $scheduleId]);
    ...
    public function ChangeDefaultStyle()
    {
        ...
        Log::Debug('Changing default style.', ['scheduleId' => $scheduleId, 'style' => $style]);
    ...
    public function ChangeMaximumConcurrentReservations()
    {
        ...
        Log::Debug('Changing maximum number of concurrent reservations.', ['scheduleId' => $scheduleId, 'maximum' => $max, 'unlimited' => $unlimited]);
    ...
    public function ChangeResourcesPerReservation()
    {
        ...
        Log::Debug('Changing maximum number of resources per reservation.', ['scheduleId' => $scheduleId, 'max' => $max, 'unlimited' => $unlimited]);

        $this->manageSchedulesService->ChangeResourcesPerReservation($scheduleId, $max, $unlimited);
    }

    public function ChangeBlockedSlotEnding()
    {
        $scheduleId = $this->page->GetScheduleId();
        $allowed = $this->page->GetReservationsCanEndInBlockedSlots();

        Log::Debug('Changing if reservations can end in blocked slots.', ['scheduleId' => $scheduleId, 'allowed' => $allowed]);

        $this->manageSchedulesService->ChangeReservationsCanEndInBlockedSlots($scheduleId, $allowed);
    }
