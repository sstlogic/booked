...
class SavedReportsPresenter extends ActionPresenter
{
    ...
    private function GenerateAndDisplay($callback)
    {
        ...
        if ($report != null) {
            Log::Debug('Loading saved report', ['userId' => $userId, 'reportId' => $reportId]);
            ...
            Log::Debug('Report not found', ['userId' => $userId, 'reportId' => $reportId]);
            $this->page->DisplayError();
        }
    }
    ...
    public function DeleteReport()
    {
        ...
        Log::Debug('Deleting saved report.', ['reportId' => $reportId, 'userId' => $userId]);
