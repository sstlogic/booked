...
class ParticipationPresenter
{
    ...
    public function PageLoad()
    {
        ...
        $reservations = $this->reservationViewRepository->GetReservations($startDate, $endDate, $userId, ReservationUserLevel::INVITEE, null, null, true);
    ...
    private function HandleInvitationAction($invitationAction)
    {
        ...
        Log::Debug('Invitation action', ['action' => $invitationAction, 'userId' => $userId, 'referenceNumber' => $referenceNumber]);
