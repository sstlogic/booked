...
class ExampleResourceGroupsResponse extends ResourceGroupsResponse
{
    public function __construct()
    {
        ...
        $group->AddResource(new ResourceGroupAssignment(0, 'Resource 1', 1, null, 2, ResourceStatus::AVAILABLE, null, false, true, true, 30, 10, 1, '#ffffff', 2, [2], "publicid1", [40], ResourceAutoReleaseAction::Delete));
        $group2->AddResource(new ResourceGroupAssignment(1, 'Resource 2', 1, null, 2, ResourceStatus::AVAILABLE, null, true, false, false, null, null, 2, '#000000', 1, [1], "publicid2", [], null));
