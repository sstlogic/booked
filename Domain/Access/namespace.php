...
require_once(ROOT_DIR . 'Domain/Access/UserGroupFilter.php');
...
require_once(ROOT_DIR . 'Domain/Access/MonitorViewRepository.php');
require_once(ROOT_DIR . 'Domain/Access/ResourceMapsRepository.php');
require_once(ROOT_DIR . 'Domain/Access/OAuthRepository.php');