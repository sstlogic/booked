...
class Schedule implements ISchedule
{
    ...
    protected $_allowReservationsToEndInBlockedSlots = false;
        ...
        $layoutId = null)
    {
        ...
        $this->_daysVisible = min($daysVisible, 14);
    ...
    public function GetDaysVisible()
    {
        return min($this->_daysVisible, 14);
    }

    public function SetDaysVisible($value)
    {
        $this->_daysVisible = min($value, 14);
    }
    ...
    public static function FromRow($row)
    {
        ...
        $schedule->SetAllowBlockedEndSlot($row[ColumnNames::ALLOW_BLOCKED_SLOT_END]);
        return $schedule;
    }
     ...
     * @return bool
     */
    public function GetAllowBlockedEndSlot()
    {
        return $this->_allowReservationsToEndInBlockedSlots;
    }

    /**
     * @param $allowed bool
     */
    public function SetAllowBlockedEndSlot($allowed)
    {
        $this->_allowReservationsToEndInBlockedSlots = (bool)intval($allowed);
    }
}
...
class NullSchedule extends Schedule
{
    public function __construct()
    {
        parent::__construct(0, null, false, Configuration::Instance()->GetKey(ConfigKeys::FIRST_DAY_OF_WEEK, new IntConverter()), 7);
    }
}
