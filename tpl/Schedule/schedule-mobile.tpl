            ...
            {foreach from=$Resources item=resource name=resource_loop}
				<tr>
					...
					<td class="resourcename"
                        ...
                        {if $resource->CanBook}
							<i data-resourceId="{$resourceId}" class="resourceNameSelector bi bi-info-circle" data-show-event="click"
					...
					<td class="" data-href="{$href}"
						...
						<div class="reservable clickres" ref="{$href}&rd={formatdate date=$date key=url}"
							...
							<i class="bi bi-plus-circle"></i> {translate key=CreateReservation}
