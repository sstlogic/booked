		...
		<table class="table" id="reservationTable" style="margin-left: auto; margin-right: auto;">
			...
			{foreach from=$Reservations item=reservation}
				...
				<tr class="{$rowCss} editable">
					...
					<td>{formatdate date=$reservation->StartDate timezone=$Timezone key=general_datetime}</td>
					<td>{formatdate date=$reservation->EndDate timezone=$Timezone key=general_datetime}</td>
